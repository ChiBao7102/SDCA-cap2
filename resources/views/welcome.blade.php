...
<body>
    ...
    <section id="home" class="slider-area pt-100">
        <div class="container-fluid position-relative">
            <div class="slider-active" style="margin-top: 20px">
                            ...
                            <div class="col-lg-8 col-md-7">
                                <div class="slider-product-content">
                                    <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s">
                                        <span>Ford</span> và <span>Mercedes</span>
                                    </h1>
                                    <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s">Tại đây chúng
                                        tôi cung cấp
                                        đầy đủ tất cả các hãng xe mà bạn mong muốn .<br>Hãy lựa chọn lạ xe mà bạn thích
                                        nhất ngay bên dưới .</p>
                    ...
                    <div class="slider-bg">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-lg-8 col-md-7">
                                <div class="slider-product-content">
                                    <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s">
                                        <span>Mùa hè</span> Sale! <span>tại đây</span>
                                    </h1>
                                    <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s">Hảy trải
                                        nghiệm mùa hè một cách trọn vẹn mà không sợ nóng,
                                        <br> không lo ngại vấn đề đi lại .
                                    </p>
                                    <a class="main-btn" href="#" data-animation="fadeInUp"
                                        data-delay="1.5s">Explore More <i class="lni-chevron-right"></i></a>
                                </div> <!-- slider product content -->
                    ...
                    <div class="slider-bg">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-lg-8 col-md-7">
                                <div class="slider-product-content">
                                    <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s">
                                        <span>Tin cậy</span> và <span>Chất lượng</span>
                                    </h1>
                                    <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s">Chúng tôi sẽ
                                        cung cấp cho bạn những dịch vụ tốt nhất . <br> Chất lượng luôn dẫn đầu
                                        đó là tiêu chí của chúng tôi .</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="single-discount-product mt-30">
                        ...
                        <div class="product-content" style="color: #fff">
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-furniture" role="tabpanel"
                            ...
                            <div class="product-items mt-30">
                                <div class="row product-items-active">
                                    @foreach ($cars_mec as $car_mec)
                                        <div class="col-md-4">
                                            <div class="single-product-items">
                                                <div class="product-item-image">
                                                    <a href="{{ route('detail-car', ['id'=>$car_mec->id]) }}" class="transaction" ><img
                                                            src="{{ $car_mec->images[0]->img_car }}"
                                                            alt="Product"></a>
                                                ...
                                                <div class="product-item-content text-center mt-30">
                                                    <h5 class="product-title"><a href="{{ route('detail-car', ['id'=>$car_mec->id]) }}" class="transaction" >{{ $car_mec->name }}</a>
                                                    </h5>
                                                    <ul class="rating">
                                                    ...
                                                    <span class="regular-price">{{ number_format($car_mec->price) }}
                                                        VND</span>
                                                </div>
                                                @if ($car_mec->status=='busy')
                                                <span class="label label-warning">Xe đã được đăng ký</span>
                                                @endif
                        ...
                        <div class="tab-pane fade" id="v-pills-decorative" role="tabpanel"
                            ...
                            <div class="product-items mt-30">
                                <div class="row product-items-active">
                                    @foreach ($cars_ford as $car_ford)
                                        <div class="col-md-4">
                                            <div class="single-product-items">
                                                <div class="product-item-image">
                                                    <a href="{{ route('detail-car', ['id'=>$car_ford->id]) }}" class="transaction"  ><img
                                                            src="{{ $car_ford->images[0]->img_car }}"
                                                            alt="Product"></a>
                                                    {{-- <div class="product-discount-tag">
                                                    <p>-60%</p>
                                                </div> --}}
                                                ...
                                                <div class="product-item-content text-center mt-30">
                                                    <h5 class="product-title"><a href="{{ route('detail-car', ['id'=>$car_ford->id]) }}" class="transaction">{{ $car_ford->name }}</a>
                                                    </h5>
                                                    <ul class="rating">
                                                        <li><i class="lni-star-filled"></i></li>
                                                        <li><i class="lni-star-filled"></i></li>
                                                    ...
                                                    <span
                                                        class="regular-price">{{ number_format($car_ford->price) }}
                                                        VND</span>
                                                </div>
                                                @if ($car_ford->status=='busy')
                                                <span class="label label-warning">Xe đã được đăng ký</span>
                                                @endif
                                            </div> <!-- single product items -->
                                        </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-lighting" role="tabpanel"
                            ...
                            <div class="product-items mt-30">
                                <div class="row product-items-active">
                                    @foreach ($cars_toyota as $car_toyota)
                                        <div class="col-md-4">
                                            <div class="single-product-items">
                                                <div class="product-item-image">
                                                    <a href="{{ route('detail-car', ['id'=>$car_toyota->id]) }}" class="transaction"><img
                                                            src="{{ $car_toyota->images[0]->img_car }}"
                                                            alt="Product"></a>
                                                    {{-- <div class="product-discount-tag">
                                                    <p>-60%</p>
                                                </div> --}}
                                                ...
                                                <div class="product-item-content text-center mt-30">
                                                    <h5 class="product-title"><a href="{{ route('detail-car', ['id'=>$car_toyota->id]) }}" class="transaction">{{ $car_toyota->name }}</a>
                                                    </h5>
                                                    <ul class="rating">
                                                        <li><i class="lni-star-filled"></i></li>
                                                        <li><i class="lni-star-filled"></i></li>
                                                    ...
                                                    <span
                                                        class="regular-price">{{ number_format($car_toyota->price) }}
                                                        VND</span>
                                                </div>
                                                @if ($car_toyota->status=='busy')
                                                <span class="label label-warning">Xe đã được đăng ký</span>
                                                @endif
                                            </div> <!-- single product items -->
                                        </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-outdoor" role="tabpanel"
                            ...
                            <div class="product-items mt-30">
                                <div class="row product-items-active">
                                    @foreach ($cars_honda as $car_honda)
                                        <div class="col-md-4">
                                            <div class="single-product-items">
                                                <div class="product-item-image">
                                                    <a href="{{ route('detail-car', ['id'=>$car_honda->id]) }}" class="transaction"><img
                                                            src="{{ $car_honda->images[0]->img_car }}"
                                                            alt="Product"></a>
                                                    {{-- <div class="product-discount-tag">
                                                    <p>-60%</p>
                                                </div> --}}
                                                ...
                                                <div class="product-item-content text-center mt-30">
                                                    <h5 class="product-title"><a href="{{ route('detail-car', ['id'=>$car_honda->id]) }}" class="transaction">{{ $car_honda->name }}</a>
                                                    </h5>
                                                    <ul class="rating">
                                                        <li><i class="lni-star-filled"></i></li>
                                                        <li><i class="lni-star-filled"></i></li>
                                                    ...
                                                    <span
                                                        class="regular-price">{{ number_format($car_honda->price) }}
                                                        VND</span>

                                                </div>
                                                @if ($car_honda->status=='busy')
                                                <span class="label label-warning">Xe đã được đăng ký</span>
                                                @endif
                                            </div> <!-- single product items -->
                                        </div>
                        ...
                        <div class="testimonial-active">
                            <div class="single-testimonial">
                                ...
                                <p class="mb-30">Lorem ipsum dolor sit amet consectetur adipisicing elit, sed
                                    do eiusmod tempor inc ididunt ut labore et dolore magna aliqua.</p>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-5 col-sm-7">
                        <div class="footer-logo mt-40">
                            ...
                            <p class="mt-10">Gravida nibh vel velit auctor aliquetn quibibendum auci elit cons
                                equat ipsutis sem nibh id elit.</p>
